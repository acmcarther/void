...
impl IcosphereMeshBuilder {
  pub fn to_mesh(self) -> Mesh {
    Mesh {
      ...
      vertices: self.vertices.into_iter().map(|(x, y, z)| Vertex { pos: [x, y, z], norm: [x, y, z]}).collect(),
...
pub fn icosphere(iterations: u32) -> Mesh {
  ...
  (0..iterations).foreach(|_| {
    icosphere_mesh_builder.faces = icosphere_mesh_builder.faces.clone().into_iter().flat_map(|(i1, i2, i3)|{
