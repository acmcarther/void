...
extern "C" {
  ...
  pub fn grpc_completion_queue_create_for_next(reserved: *mut c_void) -> *mut GrpcCompletionQueue;
  ...
  pub fn grpc_server_create(args: *const GrpcChannelArgs, reserved: *mut c_void)
    -> *mut GrpcServer;
  ...
  pub fn grpc_server_add_insecure_http2_port(server: *mut GrpcServer, addr: *const c_char)
    -> c_int;
