...
impl Default for ServerConfig {
  fn default() -> ServerConfig {
    ServerConfig {
      private_key: common::consts::PRIVATE_KEY,
      protocol_id: common::consts::PROTOCOL_ID,
      server_addr: common::flags::nio_server_addr::CONFIG.get_value(),
      max_connection_count: common::flags::max_connection_count::CONFIG.get_value(),
      max_unfragmented_packet_size: common::flags::max_unfragmented_packet_size::CONFIG
        .get_value(),
    }
  }
}
