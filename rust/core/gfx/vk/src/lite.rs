...
pub mod builtins {
  ...
  ) -> RawResult<vk_sys::DebugReportCallbackEXT> {
    instance.create_debug_callback(&vk_sys::DebugReportCallbackCreateInfoEXT {
      sType: vk_sys::STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT,
      flags: vk_sys::DEBUG_REPORT_ERROR_BIT_EXT | vk_sys::DEBUG_REPORT_WARNING_BIT_EXT,
      pNext: ptr::null(),
      pfnCallback: cb,
  ...
  pub fn make_shader_module(device: &LDevice, shader_bytes: &[u8]) -> RawResult<vk_sys::ShaderModule> {
    let shader_module_create_info = vk_sys::ShaderModuleCreateInfo {
  ...
  pub fn make_command_pool(device: &LDevice, queue_family_idx: u32) -> RawResult<vk_sys::CommandPool> {
    let command_pool_create_info = vk_sys::CommandPoolCreateInfo {
  ...
  pub fn make_semaphore(device: &LDevice) -> RawResult<vk_sys::Semaphore> {
    let semaphore_create_info = vk_sys::SemaphoreCreateInfo {
  ...
  pub fn make_fence(device: &LDevice) -> RawResult<vk_sys::Fence> {
    let fence_create_info = vk_sys::FenceCreateInfo {
  ...
  pub fn clone_viad(
    viad: &vk_sys::VertexInputAttributeDescription,
...
pub trait WindowSystemPlugin<'window> {
  ...
  unsafe fn create_surface(&mut self, instance: &LInstance) -> RawResult<vk_sys::SurfaceKHR>;
}
...
impl Vulkan {
  pub fn new(dylib_path: &'static str) -> Vulkan {
    ...
    let entry_points = vk_sys::EntryPoints::load(|symbol_name| unsafe {
      dylib
        .symbol::<*const os::raw::c_void>(symbol_name.to_str().unwrap())
        .unwrap() as *const os::raw::c_void
    });
    let static_points = vk_sys::Static::load(|symbol_name| unsafe {
      dylib
        .symbol::<*const os::raw::c_void>(symbol_name.to_str().unwrap())
        .unwrap() as *const os::raw::c_void
    });
  ...
  pub fn create_instance(
    &self,
    instance_create_info: &vk_sys::InstanceCreateInfo,
  ) -> RawResult<LInstance> {
  ...
  pub fn list_instance_extensions(&self) -> RawResult<Vec<vk_sys::ExtensionProperties>> {
  ...
  pub fn list_instance_layers(&self) -> RawResult<Vec<vk_sys::LayerProperties>> {
...
impl LInstance {
  ...
  pub fn create_debug_callback(
    &self,
    debug_report_callback_create_info_ext: &vk_sys::DebugReportCallbackCreateInfoEXT,
  ) -> RawResult<vk_sys::DebugReportCallbackEXT> {
  ...
  pub fn destroy_debug_callback(&self, debug_report_callback: vk_sys::DebugReportCallbackEXT) {
    unsafe {
  ...
  pub fn list_queue_family_properties(
  ...
  ) -> Vec<vk_sys::QueueFamilyProperties> {
    ...
    unsafe {
      ...
      let mut queue_family_properties_list: Vec<vk_sys::QueueFamilyProperties> =
  ...
  ) -> RawResult<Vec<vk_sys::ExtensionProperties>> {
  ...
  ) -> RawResult<vk_sys::SurfaceCapabilitiesKHR> {
  ...
  pub fn list_physical_device_surface_formats(
    ...
    physical_device: vk_sys::PhysicalDevice,
    surface: &vk_sys::SurfaceKHR,
  ) -> RawResult<Vec<vk_sys::SurfaceFormatKHR>> {
  ...
  ) -> vk_sys::FormatProperties {
    unsafe {
      let mut format_properties: vk_sys::FormatProperties = mem::uninitialized();
  ...
  pub fn list_physical_device_present_modes(
    ...
    physical_device: vk_sys::PhysicalDevice,
    surface: &vk_sys::SurfaceKHR,
  ) -> RawResult<Vec<vk_sys::PresentModeKHR>> {
  ...
  pub fn create_logical_device(
    &self,
    physical_device: vk_sys::PhysicalDevice,
    device_create_info: &vk_sys::DeviceCreateInfo,
  ) -> RawResult<LDevice> {
    util::loady("logical device", &|a| unsafe {
      ...
      let device_ptrs = unsafe {
        vk_sys::DevicePointers::load(|symbol_name| {
          self
            .instance_ptrs
  ...
  pub fn get_physical_device_properties(
    &self,
    physical_device: vk_sys::PhysicalDevice,
  ) -> vk_sys::PhysicalDeviceProperties {
    unsafe {
      let mut physical_device_properties: vk_sys::PhysicalDeviceProperties = mem::uninitialized();
      self
        .instance_ptrs
  ...
  pub fn get_physical_device_features(
    &self,
    physical_device: vk_sys::PhysicalDevice,
  ) -> vk_sys::PhysicalDeviceFeatures {
    unsafe {
      let mut physical_device_features: vk_sys::PhysicalDeviceFeatures = mem::uninitialized();
      self
        .instance_ptrs
  ...
  pub fn get_physical_device_memory_properties(
    &self,
    physical_device: vk_sys::PhysicalDevice,
  ) -> vk_sys::PhysicalDeviceMemoryProperties {
    unsafe {
      let mut physical_device_memory_properties: vk_sys::PhysicalDeviceMemoryProperties =
        mem::uninitialized();
      self
        .instance_ptrs
  ...
  pub fn create_xlib_surface_khr(
    &self,
    xlib_surface_create_info_khr: &vk_sys::XlibSurfaceCreateInfoKHR,
  ) -> RawResult<vk_sys::SurfaceKHR> {
...
pub struct LDevice {
  ...
  pub logical_device: vk_sys::Device,
  device_ptrs: vk_sys::DevicePointers,
}
...
impl LDevice {
  ...
  pub unsafe fn ptrs(&self) -> &vk_sys::DevicePointers {
    &self.device_ptrs
  }

  pub fn create_swapchain(
    &self,
    swapchain_create_info_khr: &vk_sys::SwapchainCreateInfoKHR,
  ) -> RawResult<vk_sys::SwapchainKHR> {
  ...
  pub fn destroy_swapchain(&self, swapchain: vk_sys::SwapchainKHR) {
    unsafe {
      self
        .device_ptrs
  ...
  // Unsafe because vk_sys::Images aren't properly tied to their parent swapchain
  pub unsafe fn get_swapchain_images(
    &self,
    swapchain: &vk_sys::SwapchainKHR,
  ) -> RawResult<Vec<vk_sys::Image>> {
  ...
  pub fn create_image_view(
    &self,
    image_view_create_info: &vk_sys::ImageViewCreateInfo,
  ) -> RawResult<vk_sys::ImageView> {
  ...
  pub fn destroy_image_view(&self, image_view: vk_sys::ImageView) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_render_pass(
    &self,
    render_pass_create_info: &vk_sys::RenderPassCreateInfo,
  ) -> RawResult<vk_sys::RenderPass> {
  ...
  pub fn destroy_render_pass(&self, render_pass: vk_sys::RenderPass) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_pipeline_layout(
    &self,
    pipeline_layout_create_info: &vk_sys::PipelineLayoutCreateInfo,
  ) -> RawResult<vk_sys::PipelineLayout> {
  ...
  pub fn destroy_pipeline_layout(&self, pipeline_layout: vk_sys::PipelineLayout) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_graphics_pipelines(
    &self,
    graphics_pipeline_layout_create_infos: &[vk_sys::GraphicsPipelineCreateInfo],
  ) -> RawResult<Vec<vk_sys::Pipeline>> {
  ...
  pub fn destroy_pipeline(&self, pipeline: vk_sys::Pipeline) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_shader_module(
    &self,
    shader_module_create_info: &vk_sys::ShaderModuleCreateInfo,
  ) -> RawResult<vk_sys::ShaderModule> {
  ...
  pub fn destroy_shader_module(&self, shader_module: vk_sys::ShaderModule) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_framebuffer(
    &self,
    framebuffer_create_info: &vk_sys::FramebufferCreateInfo,
  ) -> RawResult<vk_sys::Framebuffer> {
  ...
  pub fn destroy_framebuffer(&self, framebuffer: vk_sys::Framebuffer) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_command_pool(
    &self,
    command_pool_create_info: &vk_sys::CommandPoolCreateInfo,
  ) -> RawResult<vk_sys::CommandPool> {
  ...
  pub fn reset_command_pool(&self, command_pool: vk_sys::CommandPool) -> RawResult<()> {
  ...
  pub fn destroy_command_pool(&self, command_pool: vk_sys::CommandPool) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn allocate_command_buffers(
    &self,
    command_buffer_allocate_info: &vk_sys::CommandBufferAllocateInfo,
  ) -> RawResult<Vec<vk_sys::CommandBuffer>> {
  ...
  pub fn reset_command_buffer(&self, command_buffer: &vk_sys::CommandBuffer) -> RawResult<()> {
  ...
  pub fn create_fence(&self, fence_create_info: &vk_sys::FenceCreateInfo) -> RawResult<vk_sys::Fence> {
  ...
  pub fn destroy_fence(&self, fence: vk_sys::Fence) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_buffer(&self, buffer_create_info: &vk_sys::BufferCreateInfo) -> RawResult<vk_sys::Buffer> {
  ...
  pub fn destroy_buffer(&self, buffer: vk_sys::Buffer) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_buffer_view(
    &self,
    buffer_view_create_info: &vk_sys::BufferViewCreateInfo,
  ) -> RawResult<vk_sys::BufferView> {
  ...
  pub fn destroy_buffer_view(&self, buffer_view: vk_sys::BufferView) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn get_buffer_memory_requirements(&self, buffer: &vk_sys::Buffer) -> vk_sys::MemoryRequirements {
    unsafe {
  ...
  pub fn get_image_memory_requirements(&self, image: &vk_sys::Image) -> vk_sys::MemoryRequirements {
    unsafe {
      let mut memory_requirements = mem::uninitialized();
  ...
  pub fn allocate_memory(
    &self,
    memory_allocate_info: &vk_sys::MemoryAllocateInfo,
  ) -> RawResult<vk_sys::DeviceMemory> {
  ...
  pub fn free_memory(&self, memory: vk_sys::DeviceMemory) {
    unsafe {
      self
        .device_ptrs
  ...
  pub unsafe fn bind_buffer_memory(
    ...
    device_memory: &vk_sys::DeviceMemory,
  ) -> RawResult<()> {
    unsafe {
  ...
  pub unsafe fn map_data_to_memory<T>(&self, memory: &vk_sys::DeviceMemory, data: &T) -> RawResult<()> {
    unsafe {
      let mut bound_data: *mut *mut c_void = mem::uninitialized();
  ...
  pub fn create_descriptor_set_layout(
    &self,
    descriptor_set_layout_create_info: &vk_sys::DescriptorSetLayoutCreateInfo,
  ) -> RawResult<vk_sys::DescriptorSetLayout> {
  ...
  pub fn destroy_descriptor_set_layout(&self, descriptor_set_layout: vk_sys::DescriptorSetLayout) {
    unsafe {
  ...
  pub fn create_descriptor_pool(
    &self,
    descriptor_pool_create_info: &vk_sys::DescriptorPoolCreateInfo,
  ) -> RawResult<vk_sys::DescriptorPool> {
  ...
  pub fn destroy_descriptor_pool(&self, descriptor_pool: vk_sys::DescriptorPool) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn allocate_descriptor_sets(
    &self,
    descriptor_set_allocate_info: &vk_sys::DescriptorSetAllocateInfo,
  ) -> RawResult<Vec<vk_sys::DescriptorSet>> {
  ...
  pub fn update_descriptor_sets(
    &self,
    descriptor_set_writes: &Vec<vk_sys::WriteDescriptorSet>,
    descriptor_set_copies: &Vec<vk_sys::CopyDescriptorSet>,
  ) {
    unsafe {
  ...
  pub fn create_image(&self, image_create_info: &vk_sys::ImageCreateInfo) -> RawResult<vk_sys::Image> {
  ...
  pub fn destroy_image(&self, image: vk_sys::Image) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_sampler(
    &self,
    sampler_create_info: &vk_sys::SamplerCreateInfo,
  ) -> RawResult<vk_sys::Sampler> {
    util::loady("create image", &|a| unsafe {
      self
        .device_ptrs
  ...
  pub fn destroy_sampler(&self, sampler: vk_sys::Sampler) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn create_semaphore(
    &self,
    semaphore_create_info: &vk_sys::SemaphoreCreateInfo,
  ) -> RawResult<vk_sys::Semaphore> {
  ...
  pub fn destroy_semaphore(&self, semaphore: vk_sys::Semaphore) {
    unsafe {
      self
        .device_ptrs
  ...
  pub fn get_device_queue(&self, queue_family_idx: u32, queue_index: u32) -> vk_sys::Queue {
    unsafe {
  ...
  pub fn queue_wait_idle(&self, queue: &vk_sys::Queue) -> RawResult<()> {
