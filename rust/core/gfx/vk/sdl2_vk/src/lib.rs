...
impl<'window> vk::WindowSystemPlugin<'window> for SdlWindowSystemPlugin<'window> {
  /**
   ...
   * TODO(acmcarther): fix ^
   */
  unsafe fn create_surface(&mut self, instance: &vk::LInstance) -> vk::RawResult<vk_sys::SurfaceKHR> {
    unsafe {
